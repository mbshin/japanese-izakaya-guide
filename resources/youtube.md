...
> [03-conversation.md](../guides/03-conversation.md) 의 **실행 편**입니다.
...
```text
한국어 설명 채널 1개  ← 문법·문자 (이해용)
일본어 인풋 채널  1개  ← 귀 만들기 (노출용)
실전 회화 채널   1개  ← 리액션·뉘앙스 (모방용)
────────────────────
합계 3개. 이게 전부입니다.
```
...
| 활동 | 효과 | 하루 배분 |
| --- | --- | --- |
| 그냥 보기 (자막 켜고 감상) | 낮음 — 공부한 기분만 남음 | 10분 |
| **소리 내어 따라 하기 (섀도잉)** | **높음** | **15분** |
| **일시정지하고 내 대답 말해보기** | **가장 높음** | **10분** |

👉 **입을 안 움직인 시간은 공부 시간이 아닙니다.** 유튜브는 수동적으로 보게 만드는 매체라, 의식적으로 소리를 내야 합니다.
...
| 채널 | 링크 | 특징 | 추천 용도 |
| --- | --- | --- | --- |
| **유하다요** | [바로가기](https://www.youtube.com/channel/UCmKVnKCKWy4d1EpOVml2doA) | "쉽게 배우는 일본어" 인강 채널. 왕초보 커리큘럼이 잘 짜여 있음 | ⭐ **1주차 주력** — 히라가나·기초 문형 |
| **시원스쿨 일본어** | [바로가기](https://www.youtube.com/@siwonjapan) | 대형 어학원 공식 채널. 무료 강의 분량이 많음 | 히라가나·왕초보 시리즈 |
| **해커스일본어** | [바로가기](https://www.youtube.com/@%ED%95%B4%EC%BB%A4%EC%8A%A4%EC%9D%BC%EB%B3%B8%EC%96%B4) | 오오기·최연지 선생님 강의. JLPT~회화 폭넓음 | 문법 보충 |
| **다락원 일본어** | [바로가기](https://www.youtube.com/channel/UCumUP1MXkHUmCXNq1HQkHpA) | 교재 출판사 공식 채널. 회화·JLPT | 교재 병행 시 |
| **오오기와 틈틈이 일본어 [오틈일]** | [바로가기](https://www.youtube.com/channel/UCPtN_D043WoQ2uTWsK6ftIg) | 일본인 오오기가 한국어로 진행. **한일 문화 차이 콘텐츠가 강점** | ⭐ **§13 문화 파트** |

> 💡 **최소 구성이라면 「유하다요」 하나**로 1~2주차를 끝내세요. 여러 채널의 히라가나 강의를 번갈아 보는 건 시간 낭비입니다.
...
| 채널 | 링크 | 특징 | 추천 용도 |
| --- | --- | --- | --- |
| **Kaname Naito** | [바로가기](https://www.youtube.com/@kanamenaito) | 일본어 **뉘앙스 설명의 최강자**. "왜 이 표현이 실례인가"를 파고듦 | ⭐⭐ **§10 존댓말/반말, §13 문화** |
| **Comprehensible Japanese** (Yuki) | [바로가기](https://www.youtube.com/c/ComprehensibleJapanese) | 처음부터 끝까지 일본어만. 그림·제스처로 이해시킴. 난이도별 재생목록 | ⭐ **귀 만들기 (매일 10분)** |
| **Japanese with Shun** | [바로가기](https://www.youtube.com/@JapanesewithShun) | 입문자용 팟캐스트형. 천천히·쉬운 단어로 혼잣말 | ⭐ **섀도잉 소재** |
| **Onomappu** | [바로가기](https://www.youtube.com/channel/UCLuymDHiOySsAQ9Nc-4NoEQ) | 캐주얼 표현·의성어·슬랭 전문 | **§7 리액션, 캐주얼 말투** |
| **Miku Real Japanese** | [바로가기](https://www.youtube.com/channel/UCsQCbl3a9FtYvA55BxdzYiQ) | 실제 회화 속도, 길거리 인터뷰, 캐주얼 일본어 | **§7~8 실전 톤** |
| **Japanese Ammo with Misa** | [바로가기](https://www.youtube.com/channel/UCBSyd8tXJoEJKIXfrwkPdbA) | 문법을 깊게. 영어 설명 | 문법이 막힐 때 |
| **ToKiniAndy** | [바로가기](https://www.youtube.com/c/ToKiniAndy) | 학습자 시점의 설명. 교재 연동 강의 | 체계적 학습 |
| **PuniPuniJapan** | [바로가기](https://www.youtube.com/user/PuniPuniJapan) | 그림 중심, 아주 느림. 완전 입문자용 | 히라가나·가타카나 |
| **日本語の森** | [바로가기](https://www.youtube.com/channel/UCVx6RFaEAg46xfAsD2zz16w) | 일본어로 일본어 문법 강의. 방대함 | N5~ 문법 (2주차 이후) |
| **YUYU NIHONGO** | [바로가기](https://www.youtube.com/c/YUYUNIHONGO) | 쉬운 일본어 인풋 | 듣기 노출 |
| **JapanesePod101** | [바로가기](https://www.youtube.com/user/japanesepod101) | 상황별 표현 모음이 방대 | 상황별 표현 검색 |
...
| 채널 | 링크 | 왜 좋은가 |
| --- | --- | --- |
| **That Japanese Man Yuta** | [바로가기](https://www.youtube.com/user/YPlusShow) | 도쿄 길거리 인터뷰. 초면 대화의 실제 리듬 관찰 |
| **Ask Japanese** | [바로가기](https://www.youtube.com/channel/UCOMZWkPo7ao6yGaXc954U0w) | 다국어 자막 인터뷰. 다양한 연령대 말투 |
| **Nobita from Japan** | [바로가기](https://www.youtube.com/channel/UCcIsxujzLRO5qY5f9buahCQ) | 외국인과 일본인의 문화 차이 대담 |

> 🎯 **인터뷰 영상을 볼 때 이걸 세어보세요**: 인터뷰어가 상대 말 도중에 `うん` `そうなんですね` `へえ〜` 를 **몇 번** 넣는지.
> 세어 보면 "이렇게까지 많이?" 싶을 겁니다. 그게 정상입니다. → 본 가이드 §7
...
| 일 | 볼 것 | 할 것 | 시간 |
| --- | --- | --- | --- |
| 1–2 | **유하다요** 또는 **시원스쿨** 히라가나 강의 | 영상 보며 종이에 46자 따라 쓰기 | 40분 |
| 3 | 같은 채널 탁음·요음 편 | が·ざ·だ·ば 소리 내어 확인 | 40분 |
| 4 | 가타카나 강의 (전체 X, **내 이름·나라·취미**만) | 내 이름 가타카나 확정 | 30분 |
| 5–7 | **Comprehensible Japanese** 초급 재생목록 | 무슨 말인지 몰라도 그냥 틀어두기 | 30분 |

#### 검색 링크

- [히라가나 쓰기 읽기 강의](https://www.youtube.com/results?search_query=%ED%9E%88%EB%9D%BC%EA%B0%80%EB%82%98%20%EC%93%B0%EA%B8%B0%20%EC%9D%BD%EA%B8%B0%20%EA%B0%95%EC%9D%98)
- [가타카나 강의](https://www.youtube.com/results?search_query=%EA%B0%80%ED%83%80%EC%B9%B4%EB%82%98%20%EA%B0%95%EC%9D%98)
- [일본어 발음 장음 촉음](https://www.youtube.com/results?search_query=%EC%9D%BC%EB%B3%B8%EC%96%B4%20%EB%B0%9C%EC%9D%8C%20%EC%9E%A5%EC%9D%8C%20%EC%B4%89%EC%9D%8C) — 본 가이드 §4 발음 교정용
...
| 3–4 | **Japanese with Shun** 초기 에피소드 | **일시정지 섀도잉** — 한 문장씩 따라 말하기 |
| 5–7 | 같은 영상 반복 | 자기소개 녹음 → 원어민 발음과 비교 |

> 🎬 **2주차 필수 과제**: 내 자기소개(§6)를 **영상처럼 촬영**해 보세요. 폰 셀카로 15초. 어색해도 한 번 찍으면 실전 긴장도가 확 줄어듭니다.
...
| 일 | 볼 것 | 할 것 |
| --- | --- | --- |
| 1 | [일본어 맞장구 리액션](https://www.youtube.com/results?search_query=%EC%9D%BC%EB%B3%B8%EC%96%B4%20%EB%A7%9E%EC%9E%A5%EA%B5%AC%20%EB%A6%AC%EC%95%A1%EC%85%98) / [日本語 あいづち 練習](https://www.youtube.com/results?search_query=%E6%97%A5%E6%9C%AC%E8%AA%9E%20%E3%81%82%E3%81%84%E3%81%A5%E3%81%A1%20%E7%B7%B4%E7%BF%92) | §7의 12개 표현 확인 |
| 2–3 | **That Japanese Man Yuta** / **Ask Japanese** 인터뷰 | **인터뷰어의 아이즈치 개수 세기** |
| 4–5 | **Onomappu** / **Miku Real Japanese** | 캐주얼 말투 억양 모방 |
| 6–7 | 아무 일본어 영상 | **말 끊길 때마다 소리 내어 아이즈치 넣기** (5분 × 매일) |

> 🔥 **3주차 핵심 훈련법 — "아이즈치 더빙"**
>
> 1. 일본인 두 명이 대화하는 영상을 켠다
> 2. **듣는 사람 역할**을 내가 맡는다
> 3. 말하는 사람이 끊길 때마다 `うん` `そうなんですね` `へえ〜` `なるほど` 를 **내 입으로** 넣는다
> 4. 같은 영상으로 5회 반복
>
> 이걸 일주일 하면 실전에서 **뇌를 거치지 않고** 리액션이 나옵니다. 이 문서에서 제일 효과 좋은 훈련입니다.
...
| 일 | 볼 것 | 할 것 |
| --- | --- | --- |
| 1–2 | **Kaname Naito** — 존댓말/반말·실례되는 표현 편 | 본 가이드 §10 대조 |
| 3 | [일본어 술자리 표현](https://www.youtube.com/results?search_query=%EC%9D%BC%EB%B3%B8%EC%96%B4%20%EC%88%A0%EC%9E%90%EB%A6%AC%20%ED%91%9C%ED%98%84) | §12 확인 |
| 4 | **오틈일** — 한일 문화 차이 편 | §13 확인 |
| 5 | [日本語 初対面 会話](https://www.youtube.com/results?search_query=%E6%97%A5%E6%9C%AC%E8%AA%9E%20%E5%88%9D%E5%AF%BE%E9%9D%A2%20%E4%BC%9A%E8%A9%B1) | 초면 대화 전체 흐름 관찰 |
| 6 | — | 혼자 롤플레잉 (§2 4주차) |
| 7 | — | **실전 투입** |
...
| **일본어 자막 켜기** | 자막(CC) → 일본어 | 한국어 자막만 보면 **귀가 안 늘어납니다** |
| **자막 껐다 켜기 반복** | — | 끄고 듣기 → 켜서 확인 → 다시 끄고 듣기 |
| **구간 반복** | 영상 우클릭 → 반복 재생 | 30초 구간을 반복 재생 |
...
📁 01_히라가나        ← 1주차. 끝나면 안 봄
📁 02_자기소개        ← 2주차
📁 03_아이즈치 ⭐     ← 3주차. 모임 가기 전 차 안에서 다시 봄
📁 04_문화·매너
📁 99_모임 직전 5분   ← 여기에 3~5개만. 실전 직전 복습용
```
...
2. 아이즈치 4개 소리 내어 20번                     (2분)
3. 자기소개 1회 소리 내어                          (1분)
4. 질문 카드 3개 소리 내어                         (2분)
```

바쁜 날에도 이건 하세요. **연속성이 총량보다 중요합니다.**
...
| 함정 | 왜 문제인가 | 대신 |
| --- | --- | --- |
| 채널 20개 구독 | 뭘 볼지 고르다 시간 다 감 | 3개로 제한 |
| 한국어 자막만 보기 | 읽기 연습일 뿐 듣기가 안 늚 | 일본어 자막 병행 |
| JLPT 문법 강의부터 | 시험용 문법 ≠ 모임 회화 | 회화·리액션 우선 |
| 매일 새 영상 | 정착이 안 됨 | 같은 영상 반복 |
| 소리 안 내고 보기 | 입이 안 열림 | 무조건 소리 내기 |
| 애니메이션으로 회화 배우기 | **애니 말투는 실생활에서 이상합니다** (`だぜ` `〜のだ` 등) | 인터뷰·브이로그 |

> ⚠️ **애니메이션 주의**: 듣기 노출로는 훌륭하지만, **말투를 그대로 따라 하면 안 됩니다.** 애니 캐릭터 말투로 초면에 말하면 일본인 입장에서 상당히 이상합니다. 실제 사람이 나오는 인터뷰·브이로그를 모방 대상으로 삼으세요.
...
| 목표 | 채널 |
| --- | --- |
| 듣기 실력 늘리기 | 日本語の森, YUYU NIHONGO, Comprehensible Japanese 중급 |
| 뉘앙스 정교화 | Kaname Naito (전편 정주행 추천) |
| 문법 체계화 | Japanese Ammo with Misa, ToKiniAndy, 다락원 |
| 캐주얼 말투 | Onomappu, Miku Real Japanese |
| 일상 노출 | 일본 브이로그 채널 — 자막 없이 하루 15분 틀어두기 |
...
```text
□ 채널 3개만 골라서 구독했다 (한국어 1 / 인풋 1 / 실전 1)
□ 재생목록 5개를 만들었다
□ 재생 속도 0.75배 설정법을 안다
□ 「99_모임 직전 5분」 재생목록에 영상 3개를 담았다
□ 자기소개 15초 셀카 영상을 찍어봤다
□ 아이즈치 더빙 훈련을 일주일 했다
□ 애니 말투를 따라 하지 않기로 했다
```
...
이 문서에 실린 채널 정보는 아래 자료에서 확인했습니다.

- [Coto Academy — 50 Best YouTube Channels to Learn Japanese](https://cotoacademy.com/top-50-best-youtube-channels-learn-japanese/)
- [Migaku — Best Japanese YouTube Channels for Learners](https://migaku.com/blog/japanese/best-japanese-youtube-channels)
- [Hirakan — 13 Best YouTube Channels to Learn Japanese](https://hirakan.com/blogs/japanese/best-youtube-channels-learn-japanese)
- [Tofugu — Comprehensible Japanese Review](https://www.tofugu.com/japanese-learning-resources-database/comprehensible-japanese/)
- [minjiblog — 일본어 유튜브 채널 추천](https://minjiblog.com/japanese-youtube/)
- [위키백과 — 아이즈치(相槌)](https://ko.wikipedia.org/wiki/%EC%95%84%EC%9D%B4%EC%A6%88%EC%B9%98)
- [아시아경제 — 일본어 맞장구 표현이 많은 이유](https://www.asiae.co.kr/article/2024050315065398201)
